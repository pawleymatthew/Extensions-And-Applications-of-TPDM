...
The team affiliated with the University of Bath, called 'Uniofbathtopia', comprised myself and H. Elsom. Given our respective research interests, H. Elsom focussed on the univariate problems (Challenges 1 and 2, Section XX), while I tackled the multivariate ones (Challenges 3 and 4, Section XX). The remaining sections of our co-authored paper were researched and written jointly. Our performance is summarised in @tbl-eva-ranking.
...
#| fig-scap: "Challenge 1: Blah."
#| fig-height: 4

img1 <- rasterGrob(as.raster(readPNG("~/Documents/GitHub/Extensions-And-Applications-of-TPDM/scripts/eva-data-challenge/elsom-figs/ElbowS1_smol.png")), interpolate = FALSE)
img2 <- rasterGrob(as.raster(readPNG("~/Documents/GitHub/Extensions-And-Applications-of-TPDM/scripts/eva-data-challenge/elsom-figs/ElbowS2_smol.png")), interpolate = FALSE)
...
#| fig-scap: "Challenge 2: Blah."
#| fig-height: 3.5

img1 <- rasterGrob(as.raster(readPNG("~/Documents/GitHub/Extensions-And-Applications-of-TPDM/scripts/eva-data-challenge/elsom-figs/LossFunc3.png")), interpolate = FALSE)
...
img1 <- rasterGrob(as.raster(readPNG("~/Documents/GitHub/Extensions-And-Applications-of-TPDM/scripts/eva-data-challenge/elsom-figs/CCDF.png")), interpolate = FALSE)
img2 <- rasterGrob(as.raster(readPNG("~/Documents/GitHub/Extensions-And-Applications-of-TPDM/scripts/eva-data-challenge/elsom-figs/PostScale2.png")), interpolate = FALSE)
img3 <- rasterGrob(as.raster(readPNG("~/Documents/GitHub/Extensions-And-Applications-of-TPDM/scripts/eva-data-challenge/elsom-figs/PostShape2.png")), interpolate = FALSE)
...
img1 <- rasterGrob(as.raster(readPNG("~/Documents/GitHub/Extensions-And-Applications-of-TPDM/scripts/eva-data-challenge/elsom-figs/ShiftScaleDens.png")), interpolate = FALSE)
img2 <- rasterGrob(as.raster(readPNG("~/Documents/GitHub/Extensions-And-Applications-of-TPDM/scripts/eva-data-challenge/elsom-figs/ShiftShapeDens.png")), interpolate = FALSE)
ggarrange(img1, img2, ncol = 2)
```
...
img1 <- rasterGrob(as.raster(readPNG("~/Documents/GitHub/Extensions-And-Applications-of-TPDM/scripts/eva-data-challenge/elsom-figs/NewReturnLevel.png")), interpolate = FALSE)
...
#### Improving performance using sparse empirical estimates
