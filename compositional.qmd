...
For both processes, we generate 50 datasets of size $n=5\times 10^3$ and run the PCA methods with $k/n=0.01$. The results for other values of $k$ and $n$ are very similar -- see @sec-app-compositional-additional-results. 
