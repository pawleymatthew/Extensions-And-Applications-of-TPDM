...
### Comparison between Euclidean and Aitchison distances on the simplex {#sec-compositional-euclidean-aitchison}
...
For both processes, we generate 50 datasets of size $n=5\times 10^3$ and run the PCA methods with $k/n=0.01$.
...
#| fig-cap: "Representations of the extremal dependence structure of the 10-dimensional Hüsler-Reiss distribution parametrised by $\\Lambda_4$. Left: the matrix of tail dependence coefficients $\\chi_{ij}$. Right: eigenvectors of the model CLR-covariance matrix."
#| fig-scap: "Dependence structure of the 10-dimensional Hüsler-Reiss model parametrised by $\\Lambda_4$."
#| fig-height: 3.5
...
#| fig-scap: "CoDA- and DS-PCA applied to data from three trivariate Hüsler-Reiss models."
#| fig-height: 5
